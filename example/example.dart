...
void main(List<String> args) {
        // print(binary.serialize(StackTrace.fromString('No really a stackTrace.')).join(', '));
}
...
// class MyClass<T> {
//   MyClass({
//     required this.someItems,
//     required this.someMappedInts,
//     required this.pointer,
//   });

//   @BinaryField(0, defaultValue: {})
//   final Set<T> someItems;

//   @BinaryField(1, defaultValue: {})
//   final Map<int, bool> someMappedInts;

//   @BinaryField(2, defaultValue: )
